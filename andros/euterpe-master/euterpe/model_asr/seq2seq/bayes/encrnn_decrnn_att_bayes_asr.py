...
# torchev #
from torchev.generator import generator_rnn, generator_attention, generator_bayes_rv
...
from torchev.nn.modules.bayes import LinearBayes, NormalRV

# utilbox #
from utilbox.config_util import ConfigParser


class ENCRNN_DECRNN_ATT_BAYES_ASR(nn.Module) :
    def __init__(self, enc_in_size, dec_in_size, n_class,
            ...
            att_cfg={"type":"mlp"},
            enc_prior_cfg=None,
            dec_prior_cfg={'type':'normal', 'kwargs':{'mu':0, 'sigma':1.0}}
            ) :
        super().__init__()
        ...
        if self.dec_prior_cfg is None :
            ...
            self.pre_softmax = LinearBayes(self.dec.output_size, n_class, 
                    posterior_w=NormalRV(0, 0.05), posterior_b=NormalRV(0, 0.05),
                    prior_w=generator_bayes_rv(self.dec_prior_cfg), prior_b=generator_bayes_rv(self.dec_prior_cfg))
        pass 
    ...
    def get_config(self) :
        ...
        return {'class':str(self.__class__),
                ...
                'enc_prior_cfg':self.enc_prior_cfg,
                'dec_prior_cfg':self.dec_prior_cfg,
                }
        pass

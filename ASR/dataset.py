...
class ASRDataset(Dataset):
    def __init__(self,lang,key='ALL'):
        ...
        self.path=path=os.path.join('/project/nakamura-lab08/Work/takatomo-k/dataset/BTEC/speech/',lang,'mfcc')
        self.mean,self.std=None,None
        self.data,self.vocab=load_data(os.path.join('../TEXT',key,lang,'clean.txt'))
        self.test,self.dev,self.train=self.cleaner([get_uniq_list,check_file])
        self.get_mean()
